...
quests.questData = {
    ...
    quest_glitch = {
        ...
        reward = "I am impressed, adventurer. Voila - here is the sacred ability, as promised...\n\nSimply run into an object with a height less than 0.5 and witness your new found greatness!",
        goldReward = 500,
        grantsAbility = "jump",
